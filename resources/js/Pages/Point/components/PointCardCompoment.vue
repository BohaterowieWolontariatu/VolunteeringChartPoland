              ...
              <div class="flex space-x-2">
                <div class="flex items-center space-x-2">
                  ...
                  <div
                    ...
                    <div class="text-xs font-normal leading-none max-w-full flex-initial">{{point._fee_slots_today}}</div>
                  </div>
                </div>
                <div class="flex items-center space-x-2">
                  <div>Jutro</div>
                  <div
                    ...
                    <div class="text-xs font-normal leading-none max-w-full flex-initial">{{point._fee_slots_tommorow}}</div>
                  </div>
                </div>
                <div class="flex items-center space-x-2">
                  <div>Pojutrze</div>
                  <div
                    ...
                    <div class="text-xs font-normal leading-none max-w-full flex-initial">{{point._fee_slots_day_after_tomorrow}}</div>
                  </div>
                </div>
              </div>
            </div>
